...
DELETE WHERE day BETWEEN 20220501 AND 20220510 SETTINGS mutations_sync = 2, replication_alter_partitions_sync = 2
...
FROM (
    ...
    FROM (
        ...
        FROM (
            ...
            WHERE toYYYYMMDD(begin_time) BETWEEN 20220401 AND 20220505
            AND platform = 'jd'
