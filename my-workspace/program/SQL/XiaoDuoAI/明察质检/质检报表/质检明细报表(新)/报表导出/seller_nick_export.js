var od = getData('61dd69fa15c11556fbeda715', true)
if (!od || od.length === 0) {
    return
}

let label_fixed_titles = ["平台", "店铺", "子账号分组"],
    stat_fixed_titles = ["客服人数", "总会话量", "平均分", "AI质检量", "AI异常会话量", "AI扣分分值", "AI扣分会话比例", "AI加分会话量", "AI加分分值", "AI加分会话比例", "建议抽检量", "人工抽检量", "抽检比例", "人工扣分会话量", "人工扣分分值", "人工扣分会话比例", "人工加分会话量", "人工加分分值", "人工加分会话比例", "自定义扣分会话量", "自定义扣分分值", "自定义扣分会话比例", "自定义加分会话量", "自定义加分分值", "自定义加分会话比例"],
