...
-- DROP TABLE buffer.xqc_ads_shop_stat_buffer ON CLUSTER cluster_3s_2r NO DELAY
CREATE TABLE buffer.xqc_ads_shop_stat_buffer ON CLUSTER cluster_3s_2r
AS xqc_ads.shop_stat_all
ENGINE = Buffer('xqc_ads', 'shop_stat_all', 16, 15, 35, 81920, 409600, 16777216, 67108864)