...
-- DROP TABLE xqc_ads.company_stat_local ON CLUSTER cluster_3s_2r NO DELAY
CREATE TABLE xqc_ads.company_stat_local ON CLUSTER cluster_3s_2r
(
    `day` Int32,
    `company_id` String,
    `company_name` String,
...
-- DROP TABLE xqc_ads.company_stat_all ON CLUSTER cluster_3s_2r NO DELAY
CREATE TABLE xqc_ads.company_stat_all ON CLUSTER cluster_3s_2r
AS xqc_ads.company_stat_local
ENGINE = Distributed('cluster_3s_2r', 'xqc_ads', 'company_stat_local', rand())