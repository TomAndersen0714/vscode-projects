...
FROM (
         SELECT
             ...
             shop_id,
             snick,
             toFloat64(uniqExactIf(IF(real_buyer_nick='', cnick, real_buyer_nick), session_recv_cnt>0)) AS recv_cnick_cnt,
             toFloat64(uniqExactIf(IF(real_buyer_nick='', cnick, real_buyer_nick), session_recv_cnt>0 AND session_send_cnt>0)) AS reply_cnick_cnt,
             toFloat64(uniqExactIf(IF(real_buyer_nick='', cnick, real_buyer_nick), session_recv_cnt>0 AND m_session_send_cnt>0)) AS m_reply_cnick_cnt,
