...
DELETE WHERE day BETWEEN 20220816 AND 20220831 SETTINGS mutations_sync = 2, replication_alter_partitions_sync = 2
...
FROM (
    ...
    FROM (
        ...
        FROM (
            ...
            WHERE toYYYYMMDD(begin_time) BETWEEN 20220816 AND 20220831
            AND platform = 'tb'
