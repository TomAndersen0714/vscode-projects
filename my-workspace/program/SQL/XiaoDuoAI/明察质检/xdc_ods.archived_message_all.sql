CREATE TABLE xqc_ods.archived_message_local
(
    `_id` String,
    `raw_id` String,
    `dialog_id` String,
    ...
    `day` UInt32,
    INDEX dialog_id_idx dialog_id TYPE bloom_filter GRANULARITY 1
)
ENGINE = ReplicatedMergeTree('/clickhouse/xqc_ods/tables/{layer}_{shard}/archived_message_local', '{replica}')
PARTITION BY day
