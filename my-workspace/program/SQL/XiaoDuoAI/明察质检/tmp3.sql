...
-- feishu_ods.feishu_work_item_pub_local
DROP TABLE IF EXISTS feishu_ods.feishu_work_item_pub_local ON CLUSTER cluster_3s_2r NO DELAY;

CREATE TABLE feishu_ods.feishu_work_item_pub_local ON CLUSTER cluster_3s_2r
(
...
-- feishu_ods.feishu_work_item_pub_all
...
ENGINE = Distributed('cluster_3s_2r', 'feishu_ods', 'feishu_work_item_pub_local', xxHash64(`project_key`,`id`));

-- buffer.feishu_work_item_pub_buffer
...
-- feishu_ods.feishu_work_item_custom_local
DROP TABLE IF EXISTS feishu_ods.feishu_work_item_custom_local ON CLUSTER cluster_3s_2r NO DELAY;

CREATE TABLE feishu_ods.feishu_work_item_custom_local ON CLUSTER cluster_3s_2r (
    `project_key` String COMMENT '空间id',
    `id` Int32 COMMENT '工作项id',
...
-- feishu_ods.feishu_work_item_custom_all
...
ENGINE = Distributed('cluster_3s_2r', 'feishu_ods', 'feishu_work_item_custom_local', xxHash64(`project_key`,`id`));

-- buffer.feishu_work_item_custom_buffer
...
-- feishu_ods.user_mes_local
DROP TABLE IF EXISTS feishu_ods.user_mes_local ON CLUSTER cluster_3s_2r NO DELAY;

CREATE TABLE feishu_ods.user_mes_local ON CLUSTER cluster_3s_2r (
    `user_key` String,
    `username` String
)
ENGINE = ReplicatedMergeTree('/clickhouse/{database}/tables/{layer}_{shard}/{table}', '{replica}')
...
-- feishu_ods.user_mes_all
DROP TABLE IF EXISTS feishu_ods.user_mes_all ON CLUSTER cluster_3s_2r NO DELAY;

CREATE TABLE IF NOT EXISTS  feishu_ods.user_mes_all ON CLUSTER cluster_3s_2r
AS feishu_ods.user_mes_local
ENGINE = Distributed('cluster_3s_2r', 'feishu_ods', 'user_mes_local', xxHash64(`user_key`,`username` ));