...
#bdp放入指定目录
  ...
  cd ${CURRENT_DIR}/aml_java/blanca-300/
  mvn clean install -DskipTests -Dmaven.javadoc.skip=true
  cp ${CURRENT_DIR}/aml_java/blanca-300/target/blanca-300-*.jar ${bdp_dist_dir}/lib/blanca-300.jar
  ...
  mkdir ${TARGET_DIR}
  PKG_NAME=${SUBSYSTEM_NAME}_300_bdp_hive_wtss_${PRODUCT_VERSION}_${BUILD_NUMBER}.tar.gz
  cd  ${CURRENT_DIR}/dist/
