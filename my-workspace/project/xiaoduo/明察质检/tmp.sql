-- DROP TABLE xqc_ods.alert_local ON CLUSTER cluster_3s_2r NO DELAY;
...
-- DROP TABLE xqc_ods.alert_all ON CLUSTER cluster_3s_2r NO DELAY;
...
-- DROP TABLE buffer.xqc_ods_alert_buffer ON CLUSTER cluster_3s_2r NO DELAY;
