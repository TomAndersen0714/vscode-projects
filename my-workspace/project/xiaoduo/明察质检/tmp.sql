...
FROM (
        SELECT corp_id,
            ...
            floor(
                if(order_count > 0, payment_sum / order_count, 0),
                2
            ) as per_payment,
            arraySum(
                arrayFilter(
        ...
        FROM (
            SELECT day,
                ...
                before.first_order_time > 0
                AND before.first_order_time < order_time as tag
            FROM (
                WITH toYYYYMMDD(toDate('2023-01-05')) AS starts,
            ...
            LEFT JOIN (
                ...
                GROUP BY platform,
                    ...
                    shop_id,
                    bind_nick
            ) AS before using (platform, corp_id, shop_id, bind_nick)
        )
        GROUP BY corp_id
