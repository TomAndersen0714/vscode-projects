...
on a._id=b._id  where b._id<>''

-- 强制合并
optimize table dwd.xdqc_dialog_all  partition 20210710 final
...
-- 强制合并
optimize table dwd.xdqc_dialog_all  partition 20210711 final
...
-- 强制合并
optimize table dwd.xdqc_dialog_all  partition 20210712 final