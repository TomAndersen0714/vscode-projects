SELECT
    company_id, shop_id,
    seller_nick, platform, group, snick,
    employee_id, employee_name, department_id, department_name,
    mark_employee_id, mark_employee_name,
    ...
    FROM (
        ...
        FROM (
            SELECT
                ...
                tag_id,
                tag_score,
                last_mark_id AS mark_employee_id
...
ON tag_detial.mark_employee_id = employee_info.employee_id