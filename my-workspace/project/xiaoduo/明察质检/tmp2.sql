CREATE TABLE buffer.xdqc_dialog_buffer (
    ...
    `qid` Array(Int64),
    `service_evaluations_eval_code` Array(Int64),
    `service_evaluations_open_uid` Array(String),
    `service_evaluations_eval_time` Array(String),
    `service_evaluations_send_time` Array(String),
    `service_evaluations_source` Array(Int64),
    `service_evaluations_message_id` Array(String),
    `service_evaluations_desc` Array(String),
    `mark` String,
    `mark_time` DateTime64(3),
    `message_marks_id` Array(String),
    `message_marks_mark` Array(String),
    `mark_judge` Int32,
    `mark_score` Int32,
    ...
    `order_info_history_status` Array(Array(String)),
    `order_info_history_time` Array(Array(UInt64)),
