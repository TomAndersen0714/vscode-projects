...
-- 案例分析所需表(已废弃此功能) ods.qc_case_label_detail_all

-- 时间范围
WHERE toYYYYMMDD(date) BETWEEN 20210817 AND 20210831
...
"select * from ods.qc_session_count_all WHERE toYYYYMMDD(date) BETWEEN 20210817 AND 20210831 FORMAT Avro" \
> /tmp/ods.qc_session_count_all_20210817_20210831.Avro

docker exec -i 9e clickhouse-client --port=19000 --query=\
"select * from ods.qc_read_mark_detail_all WHERE toYYYYMMDD(date) BETWEEN 20210817 AND 20210831 FORMAT Avro" \
> /tmp/ods.qc_read_mark_detail_all_20210817_20210831.Avro

docker exec -i 9e clickhouse-client --port=19000 --query=\
"select * from ods.qc_question_detail_all WHERE toYYYYMMDD(date) BETWEEN 20210817 AND 20210831 FORMAT Avro" \
> /tmp/ods.qc_question_detail_all_20210817_20210831.Avro

docker exec -i 9e clickhouse-client --port=19000 --query=\
"select * from ods.qc_words_detail_all WHERE toYYYYMMDD(date) BETWEEN 20210817 AND 20210831 FORMAT Avro" \
> /tmp/ods.qc_words_detail_all_20210817_20210831.Avro

-- 老淘宝 zjk-bigdata005 复制 zjk-bigdata006 数据到OSS盘
scp root@zjk-bigdata006:/tmp/ods.qc_session_count_all_20210817_20210831.Avro /opt/bigdata/
scp root@zjk-bigdata006:/tmp/ods.qc_read_mark_detail_all_20210817_20210831.Avro /opt/bigdata/
scp root@zjk-bigdata006:/tmp/ods.qc_question_detail_all_20210817_20210831.Avro /opt/bigdata/
scp root@zjk-bigdata006:/tmp/ods.qc_words_detail_all_20210817_20210831.Avro /opt/bigdata/
...
-- v1mini-bigdata-002 CH(1b73e87dc75e)备份融合版已有数据(已经备份过,故不需要再次备份)
...
-- v1mini-bigdata-002 CH(1b73e87dc75e) 删除脏数据
ALTER TABLE ods.qc_session_count_local ON CLUSTER cluster_3s_2r
DELETE WHERE toYYYYMMDD(date) BETWEEN 20210817 AND 20210831

ALTER TABLE ods.qc_read_mark_detail_local ON CLUSTER cluster_3s_2r
DELETE WHERE toYYYYMMDD(date) BETWEEN 20210817 AND 20210831

ALTER TABLE ods.qc_question_detail_local ON CLUSTER cluster_3s_2r
DELETE WHERE toYYYYMMDD(date) BETWEEN 20210817 AND 20210831

ALTER TABLE ods.qc_words_detail_local ON CLUSTER cluster_3s_2r
DELETE WHERE toYYYYMMDD(date) BETWEEN 20210817 AND 20210831
...
< /opt/bigdata/ods.qc_session_count_all_20210817_20210831.Avro

-- ods.qc_read_mark_detail_all
docker exec -i 1b7 clickhouse-client --port=19000 --query=\
"INSERT INTO buffer.ods_qc_read_mark_detail_buffer FORMAT Avro" \
< /opt/bigdata/ods.qc_read_mark_detail_all_20210817_20210831.Avro

-- ods.qc_question_detail_all
docker exec -i 1b7 clickhouse-client --port=19000 --query=\
"INSERT INTO buffer.qc_question_detail_buffer FORMAT Avro" \
< /opt/bigdata/ods.qc_question_detail_all_20210817_20210831.Avro

-- ods.qc_words_detail_all
docker exec -i 1b7 clickhouse-client --port=19000 --query=\
"INSERT INTO buffer.qc_words_detail_all_buffer FORMAT Avro" \
< /opt/bigdata/ods.qc_words_detail_all_20210817_20210831.Avro
