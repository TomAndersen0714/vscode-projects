...
parse_command_type_jobs() {
    ...
    class_patterns["client"]="ETL_SUBMIT,python_utils/etlTool.py|HAML_PYTHON_ETL_TOOL,pythonUtil/etlTool.py"
    class_patterns["subtype"]="blanca,spark,hive,etl,echo,checkDate,sqoop,monitor"
