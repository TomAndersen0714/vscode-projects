...
-- PS: 剩余质检词排行所需表 ods.qc_words_detail_all
-- 案例分析所需表(已废弃此功能) ods.qc_case_label_detail_all

-- 时间范围
WHERE toYYYYMMDD(date) BETWEEN 20210601 AND 20210630
WHERE toYYYYMMDD(date) BETWEEN 20210701 AND 20210731
WHERE toYYYYMMDD(date) BETWEEN 20210801 AND 20210816
-- 汇总
...
-- v1mini-bigdata-002 CH(1b73e87dc75e)备份融合版已有数据
